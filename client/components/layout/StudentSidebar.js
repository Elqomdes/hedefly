...
const navigation = [
  ...
  { name: 'Ödevlerim', href: '/student/assignments', icon: BookOpenIcon },
  { name: 'Sınavlarım', href: '/student/exams', icon: ClipboardDocumentListIcon },
  { name: 'Sınıflarım', href: '/student/classes', icon: AcademicCapIcon },
  { name: 'Planlarım', href: '/student/plans', icon: ChartBarIcon },
  { name: 'Ayarlar', href: '/student/settings', icon: Cog6ToothIcon },
];
